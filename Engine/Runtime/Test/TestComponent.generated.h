...
void ReflectionRegister_TestComponent()
{
    ...
    cls->m_properties = prop_m_testFloat;
    prop_m_testFloat->m_next = prop_m_texture;
    // Register the class in the reflection registry
    ReflectionRegistry::Get().RegisterClass(cls);
}

static ReflectionRegistration registration_TestComponent(ReflectionRegister_TestComponent);
