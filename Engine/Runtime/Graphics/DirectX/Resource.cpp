...
Resource::Resource(Microsoft::WRL::ComPtr<ID3D12Device>& device, const D3D12_RESOURCE_DESC& resourceDesc, const D3D12_CLEAR_VALUE* clearValue )
: m_Device( device )
{
...
Resource::Resource(Microsoft::WRL::ComPtr<ID3D12Device>& device, Microsoft::WRL::ComPtr<ID3D12Resource> resource,
