#include "Graphics/DirectX/Material.h"
...
std::shared_ptr<DirectX12Texture> Material::GetTexture( TextureType ID ) const
{
...
void Material::SetTexture(TextureType type, std::shared_ptr<DirectX12Texture> texture)
{
