...
constexpr GpuShaderStageSpec kAllRuntimeShaderStages[] = {
    ...
    { "Shaders/PostProcess_ColorGrading.slang", "VSMain", "vs_6_6" },
    { "Shaders/PostProcess_ColorGrading.slang", "PSMain", "ps_6_6" },
    { "Shaders/PostProcess_Vignette.slang", "VSMain", "vs_6_6" },
    { "Shaders/PostProcess_Vignette.slang", "PSMain", "ps_6_6" },
